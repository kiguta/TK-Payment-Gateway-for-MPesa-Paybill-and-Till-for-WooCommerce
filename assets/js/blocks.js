( function( wc, wp ) {
	...
	var Label = function() {
		return createElement( 'span', null, settings.title || __( 'MPesa Payments', 'tk-paybill-and-till-checkout-for-mpesa' ) );
	};
			...
			var unsubscribe = eventRegistration.onPaymentSetup( function() {
				if ( ! phone ) {
					return {
						...
						message: __( 'MPesa Phone Number is required!', 'tk-paybill-and-till-checkout-for-mpesa' ),
					};
				}
				return {
		...
		return createElement(
			...
			createElement(
				...
				createElement(
					...
					__( 'MPesa Phone Number', 'tk-paybill-and-till-checkout-for-mpesa' ),
					' ',
				...
				createElement( 'input', {
					...
					autoComplete: 'off',
					required:    true,
					className:   'tk-mpesa-phone-input',
				} )
			)
		);
	};
	...
	registerPaymentMethod( {
		...
		ariaLabel:      settings.title || __( 'MPesa Payments', 'tk-paybill-and-till-checkout-for-mpesa' ),
