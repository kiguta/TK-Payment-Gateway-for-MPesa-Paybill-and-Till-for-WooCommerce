# Contributing to TK Paybill and Till Checkout for M-Pesa
...
- All user-facing strings wrapped in `__()` / `esc_html__()` with text domain `tk-paybill-and-till-checkout-for-mpesa`
